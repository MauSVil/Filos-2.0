...
const Home = () => {
  return (
    // <div className="flex flex-col flex-wrap items-start justify-center gap-6 sm:flex-row sm:p-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-6 gap-4 p-4">
      ...
      {/* <Card className="col-span-1 md:col-span-2 md:row-span-2">
        <CardContent className="p-4">Card 3 - Tall</CardContent>
      </Card>

      <Card className="col-span-1 md:col-span-4 md:row-span-2">
        <CardContent className="p-4">Card 4 - Big</CardContent>
      </Card>

      <Card className="col-span-1 md:col-span-2 row-span-1">
        <CardContent className="p-4">Card 5</CardContent>
      </Card>

      <Card className="col-span-1 md:col-span-2 row-span-1">
        <CardContent className="p-4">Card 6</CardContent>
      </Card> */}
    </div>
  );
};
